    ...
    required VoidCallback onPressed,
      ...
      builder: (BuildContext context) => Directionality(
        ...
        child: AlertDialog(
          ...
          elevation: 2,
          backgroundColor: context.read<SwitchesProvider>().isDark ? Colors.black : Colors.white,
          ...
          content: SizedBox(
            ...
            child: Column(
              children: [
                FittedBox(
                  child: Text(text,
                      style: textStyle(context, context.read<SwitchesProvider>().isDark ? Colors.white : Colors.black,
                          getWidth(context) * 0.04, FontWeight.bold)),
                ),
                Expanded(
                  child: Padding(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ElevatedButton(
                                style: ButtonStyle(
                                    backgroundColor:
                                        MaterialStateProperty.all(context.read<SwitchesProvider>().isDark ? Colors.black : Colors.white,),
                                ...
                                child: Text(
                                  'لا',
                                  style: textStyle(context, context.read<SwitchesProvider>().isDark ? Colors.white :lightFirstColor,
                                      getWidth(context) * 0.03),
                                )),
                          ),
                        ),
