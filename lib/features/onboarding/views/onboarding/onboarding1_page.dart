...
import 'widgets/page_number_circle_widget.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextWidget(
                    text: context.appLocalization.onboarding1Title,
                    size: width * 0.05,
                ...
                Padding(
                  ...
                  child: TextWidget(
                    text: context.appLocalization.onboarding1Body,
                    size: width * 0.035,
                    textAlign: TextAlign.center,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      PageNumberCircleWidget(
                        currentPage: 1,
                        onNextPage: () =>
                            context.pushNamed(RoutingConstants.onboarding2Page),
                      ),
                    ],
                  ),
                ),
